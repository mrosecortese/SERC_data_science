...
And that's it! This third application is also located in "/app-example/" to show you how you might organize a Shiny application for regular development and publication on a Shiny server. 

Check out additional Shiny resources in the `shiny-resources.md` file. 
